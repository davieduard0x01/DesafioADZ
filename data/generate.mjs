...
w("ga.json", {
  ...
  periodo: { inicio: INICIO, fim: FIM },
  notas: {
    anomalia: `A partir de ${DATA_TROCA} o canal direct/(none) sobe e paid_social cai no mesmo volume: são as sessões do anúncio ${AD_AFETADO}, cujo link virou encurtador e perdeu as UTMs.`,
  },
